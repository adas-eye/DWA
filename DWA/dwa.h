...
double **DynamicWindowApproach(double **x, double model[6], double goal[2], double evalParam[4], double ob[18][2], double R);
double *CalcDynamicWindow(double **x, double model[6]);
std::vector<double*> Evaluation(double **x, double *Vr, double goal[2], double ob[18][2], double R, double model[6], double evalParam[4]);
